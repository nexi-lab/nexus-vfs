...
#[cfg(all(feature = "grpc", has_protos))]
pub use client::{
    call_delete_zone, call_discover_zones_rpc, call_get_crl, call_join_cluster,
    call_join_zone_rpc, call_remove_voter_rpc, ClientConfig, ClusterInfoResult, DiscoveredZone,
