...
use crate::raft::storage::{RedbStore, RedbTree};

// Advisory lock types are the shared SSOT, defined in `nexus_vfs_core::contracts::lock_state`.
// Re-exported from this module (and from `crate::raft::raft`) so existing
// callers keep their `use raft::{LockMode, ...}` paths.
pub use nexus_vfs_core::contracts::lock_state::{
...
// `nexus_vfs_core::contracts::lock_state` and re-exported at the top of this file. All
