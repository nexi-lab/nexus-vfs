...
use crate::raft::raft::StateMachine;
use crate::raft::raft::{
...
use crate::raft::zone_handle::ZoneHandle;
...
pub struct ZoneManager {
    ...
    blob_fetcher_slot: crate::raft::blob_fetcher::BlobFetcherSlot,
...
impl ZoneManager {
    ...
    pub fn with_node_id(
        ...
        let blob_fetcher_slot = crate::raft::blob_fetcher::new_blob_fetcher_slot();
    ...
    pub fn blob_fetcher_slot(&self) -> crate::raft::blob_fetcher::BlobFetcherSlot {
    ...
    pub fn register_share(&self, origin_path: &str, zone_id: &str) -> Result<()> {
        let root = self
            .registry
            .get_node(nexus_vfs_core::contracts::ROOT_ZONE_ID)
            .ok_or_else(|| {
