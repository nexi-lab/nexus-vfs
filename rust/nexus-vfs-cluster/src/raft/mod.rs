...
//   zone_meta_store.rs         — Raft-backed `nexus_vfs_core::kernel::abc::MetaStore` impl
...
// / pipe backends live in `nexus_vfs_core::kernel::core::stream::wal` / `nexus_vfs_core::kernel::core::pipe::wal`
...
// (`nexus_vfs_core::kernel::core::stream::wal`, `nexus_vfs_core::kernel::core::pipe::wal`) — they
...
pub mod prelude {
    pub use crate::raft::storage::{RedbBatch, RedbStore, RedbTree, RedbTreeBatch, StorageError};
    ...
    pub use crate::raft::raft::{NodeRole, RaftConfig, RaftStorage, ZoneConsensus};

    #[cfg(all(feature = "grpc", has_protos))]
    pub use crate::raft::transport::{
