...
pub(crate) async fn forward_propose(
    ...
    command: crate::raft::raft::Command,
    zone_id: &str,
    cached_client: &tokio::sync::Mutex<Option<(String, RaftApiClient)>>,
) -> crate::raft::raft::Result<crate::raft::raft::CommandResult> {
...
) -> crate::raft::raft::CommandResult {
    use crate::raft::raft::{CommandResult, HolderInfo, LockAcquireResult, LockMode};
