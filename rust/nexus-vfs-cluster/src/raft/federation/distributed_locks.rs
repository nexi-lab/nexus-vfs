...
//!
//! Implements the ``nexus_vfs_core::contracts::Locks`` trait on top of a
...
use nexus_vfs_core::contracts::lock_state::{LockInfo, LockMode, LockState, Locks};

use crate::raft::raft::{Command, CommandResult, FullStateMachine, ZoneConsensus};
...
impl DistributedLocks {
    ...
    pub fn new(
        ...
        // reach this path:
        //
        //   1. ``nexus_vfs_core::kernel::sys_setattr DT_MOUNT`` — sync gRPC handler
