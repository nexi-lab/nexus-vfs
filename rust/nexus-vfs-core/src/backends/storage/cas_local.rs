...
//! ([`crate::kernel::cas_engine::CASEngine`]) with
//! [`crate::kernel::cas_transport::LocalCASTransport`] for the on-disk
...
use crate::kernel::cas_engine::CASEngine;
...
impl CasLocalBackend {
    ...
    pub fn new_with_fetcher(
        root: &Path,
        fsync: bool,
        fetcher: std::sync::Arc<dyn crate::kernel::cas_remote::RemoteChunkFetcher>,
    ) -> io::Result<Self> {
        let transport = LocalCASTransport::new(root, fsync)?;
...
mod tests {
    use super::*;
    use crate::backends::storage::local_connector::LocalConnectorBackend;
    use crate::backends::storage::path_local::PathLocalBackend;
    ...
    fn test_ctx() -> crate::kernel::kernel::OperationContext {
        crate::kernel::kernel::OperationContext::new("test", "root", false, None, false)
    }
