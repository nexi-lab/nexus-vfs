...
impl ObjectStore for PathLocalBackend {
    ...
    fn write_content(
        ...
        if offset == 0 {
            ...
            let hash = crate::util::hash::hash_content(content);
        ...
        let hash = crate::util::hash::hash_content(&final_bytes);
...
impl crate::backends::addressing::path::PathAddressingEngine for PathLocalBackend {
    fn stream_content(
        &self,
        _content_id: &str,
        backend_path: &str,
        chunk_size: usize,
    ) -> Result<crate::backends::addressing::path::ContentStream, StorageError> {
    ...
    fn read_path(&self, _content_id: &str, backend_path: &str) -> Result<Vec<u8>, StorageError> {
        ...
        let ctx = crate::kernel::kernel::OperationContext::new("", "", false, None, true);
