...
//! configured). The trait boundary ``Arc<dyn crate::contracts::Locks>``
...
use crate::contracts::lock_state::{LockInfo, LockMode, LockState, Locks};

use crate::kernel::lock_manager::lock_now_secs;
