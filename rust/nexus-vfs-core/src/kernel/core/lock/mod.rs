...
//!     Backed by the shared `Arc<Mutex<crate::contracts::LockState>>` — same Arc
...
use crate::contracts::lock_state::{
...
fn shared_lock_to_kernel(lock: crate::contracts::LockInfo) -> KernelLockInfo {
    KernelLockInfo {
        path: lock.path,
