...
//! `crate::kernel::abc::meta_store`; this module is the home for the
...
// `use crate::kernel::core::meta_store::{MetaStore, FileMetadata, …}` (or the
// flat `crate::kernel::meta_store::…` shim) reach the canonical declaration in
// `crate::kernel::abc::meta_store` without churn. This is a stable compat
// alias, not a parallel declaration.
pub use crate::kernel::abc::meta_store::{
...
// pas_update_content_id is defined in crate::kernel::abc::meta_store and re-exported
