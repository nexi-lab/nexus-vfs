...
use crate::kernel::vfs_router::canonicalize_mount_path as canonicalize;
...
impl Kernel {
    ...
    pub(crate) fn add_mount(
        ...
        if mount_point == "/" && zone_id == crate::contracts::ROOT_ZONE_ID {
    ...
    pub fn install_mount_metastore(
        ...
        ms: Arc<dyn crate::kernel::meta_store::MetaStore>,
    ) {
