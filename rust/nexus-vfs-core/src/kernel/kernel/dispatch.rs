...
use crate::kernel::dispatch::{HookContext, NativeInterceptHook, Permission, PermissionProvider};
...
impl Kernel {
    ...
    /// Register a native Rust hook (e.g. `crate::services::audit::AuditHook`)
    ...
    /// (crate::services::audit, etc.) and call this from their PyO3 entry
    /// points.
    ...
    pub fn register_managed_service(
        &self,
        name: &str,
        instance: Box<dyn crate::kernel::service_registry::ServiceLifecycle>,
        exports: Vec<String>,
    ...
    pub fn swap_managed_service(
        &self,
        name: &str,
        new_instance: Box<dyn crate::kernel::service_registry::ServiceLifecycle>,
        exports: Vec<String>,
        timeout_ms: u64,
    ) -> Result<(), String> {
        self.service_registry
    ...
    pub fn service_lookup_managed(
        &self,
        name: &str,
    ) -> Option<Box<dyn crate::kernel::service_registry::ServiceLifecycle>> {
    ...
    pub fn register_rust_service(
        &self,
        name: &str,
        instance: std::sync::Arc<dyn crate::kernel::service_registry::RustService>,
        exports: Vec<String>,
    ) -> Result<(), String> {
        self.service_registry
    ...
    pub(crate) fn service_lookup_rust(
        &self,
        name: &str,
    ) -> Option<std::sync::Arc<dyn crate::kernel::service_registry::RustService>> {
    ...
    pub fn dispatch_rust_call(
        ...
        method: &str,
        payload: &[u8],
    ) -> Option<Result<Vec<u8>, crate::kernel::service_registry::RustCallError>> {
