...
//! Reads from the [`crate::kernel::core::agents::registry::AgentRegistry`] SSOT; ownership is
...
//! `crate::kernel::core::dispatch::PathResolver`.

use crate::kernel::core::agents::registry::AgentRegistry;
use crate::kernel::core::dispatch::PathResolver;
use std::sync::Arc;
...
mod tests {
    use super::*;
    use crate::kernel::core::agents::registry::{AgentDescriptor, AgentKind, AgentState};
