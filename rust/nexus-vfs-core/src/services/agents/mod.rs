...
//! at [`crate::kernel::core::agents::registry`] — that's where the data
...
//!   impls `crate::kernel::core::dispatch::PathResolver`.
//!
//! `mailbox_stamping` used to live here; it moved to
//! `crate::kernel::managed_agent::mailbox_stamping_policy` because the policy
