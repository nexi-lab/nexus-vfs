...
use crate::services::matrix_adapter::room_id::encode_room_id;
...
pub async fn sync<K: crate::kernel::abi::KernelAbi>(
...
async fn pump_rooms<K: crate::kernel::abi::KernelAbi>(
    kernel: &Arc<K>,
    joined: &[String],
    offsets: &mut HashMap<String, u64>,
    server_name: &str,
    ctx: &crate::kernel::kernel::OperationContext,
...
fn pump_one_room<K: crate::kernel::abi::KernelAbi>(
    kernel: &Arc<K>,
    stream_path: &str,
    server_name: &str,
    start: u64,
...
mod tests {
    ...
    use crate::services::matrix_adapter::router::{build_router, AdapterState};
