...
use crate::services::matrix_adapter::auth::{AuthBackendRef, AuthError, AuthSession};
use crate::services::matrix_adapter::error::AdapterError;
use crate::services::matrix_adapter::media;
use crate::services::matrix_adapter::middleware::require_access_token;
use crate::services::matrix_adapter::push;
use crate::services::matrix_adapter::rooms::{
...
pub struct AdapterState<K: crate::kernel::abi::KernelAbi> {
...
impl<K: crate::kernel::abi::KernelAbi> AdapterState<K> {
...
impl<K: crate::kernel::abi::KernelAbi> Clone for AdapterState<K> {
    fn clone(&self) -> Self {
        Self {
...
pub fn build_router<K: crate::kernel::abi::KernelAbi>(state: AdapterState<K>) -> Router {
...
async fn login<K: crate::kernel::abi::KernelAbi>(
...
async fn logout<K: crate::kernel::abi::KernelAbi>(
    State(state): State<AdapterState<K>>,
...
mod tests {
    ...
    fn fixture(seed_users: &[(&str, &str)]) -> Router {
        ...
        let state = AdapterState::<crate::kernel::kernel::Kernel>::new(
            backend,
