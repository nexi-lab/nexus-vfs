...
use crate::contracts::is_system_path;
use crate::kernel::core::dispatch::{HookContext, HookOutcome, NativeInterceptHook};
...
impl NativeInterceptHook for MailboxStampingHook {
    ...
    fn on_pre(&self, ctx: &HookContext) -> Result<HookOutcome, String> {
        ...
        // Python (see `crate::contracts::SYSTEM_PATH_PREFIX`). Today the
...
mod tests {
    use super::*;
    use crate::kernel::core::dispatch::{HookIdentity, ReadHookCtx, WriteHookCtx};
