...
//!
//! Companion to `crate::kernel::abc::*` (Storage HAL §3.A — the 3 ABC pillars).
...
//!   `crate::backends::*`. Concrete impl in `crate::backends::python::factory`.
//! * [`peer`] — re-export of `crate::util::transport_primitives::PeerBlobClient`.
...
//!   each other.
//!
//! ObjectStore extension hooks like [`crate::kernel::llm_streaming::LlmStreamingBackend`]
...
// `PeerBlobClient` lives in `crate::util::transport_primitives` — the
