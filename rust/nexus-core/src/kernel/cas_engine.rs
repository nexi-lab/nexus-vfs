...
use crate::kernel::cas_chunking::{finalize_manifest, read_and_verify_chunk, ChunkingStrategy};
use crate::kernel::cas_remote::RemoteChunkFetcher;
use crate::kernel::cas_transport::LocalCASTransport;
...
impl From<CASError> for crate::kernel::abc::object_store::StorageError {
    fn from(e: CASError) -> Self {
        match e {
            CASError::NotFound(s) => crate::kernel::abc::object_store::StorageError::NotFound(s),
            CASError::IOError(e) => crate::kernel::abc::object_store::StorageError::IOError(e),
        }
    }
}
...
pub struct CASEngine {
    ...
    chunk_assembler: Option<Arc<dyn crate::kernel::cas_chunking::ChunkAssembler>>,
    chunking_strategy: Option<Arc<dyn crate::kernel::cas_chunking::ChunkingStrategy>>,
...
impl CASEngine {
    ...
    pub fn new(transport: LocalCASTransport) -> Self {
        Self {
            transport,
            chunk_assembler: Some(crate::kernel::cas_chunking::default_chunk_assembler()),
            chunking_strategy: Some(crate::kernel::cas_chunking::default_chunking_strategy()),
            fetcher: None,
...
mod tests {
    ...
    fn test_hash_consistency_with_library() {
        ...
        let direct_hash = crate::util::hash::hash_content(content);
    ...
    fn setup_msg_boundary() -> (TempDir, CASEngine) {
        ...
        let engine = CASEngine::with_strategy(
            transport,
            Arc::new(crate::kernel::cas_chunking::MessageBoundaryStrategy),
        );
        (tmp, engine)
    }
    ...
    use crate::kernel::cas_remote::RemoteChunkFetcher as _RemoteFetcher;
