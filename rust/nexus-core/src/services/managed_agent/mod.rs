...
pub fn install_managed_agent_with_spawn(
    kernel: &Arc<crate::kernel::kernel::Kernel>,
    spawn_provider: Arc<dyn SpawnTask<crate::kernel::kernel::Kernel>>,
) -> Result<(), String> {
    ManagedAgentService::<crate::kernel::kernel::Kernel>::install_with_spawn(kernel, spawn_provider)
}

/// Install ManagedAgentService on `kernel` without a runtime body
/// (procfs + AgentRegistry only). Mirrors the existing pyo3 path
/// `crate::services::services::python::nx_managed_agent_install` for callers that
/// don't ship a runtime.
pub fn install_managed_agent(kernel: &Arc<crate::kernel::kernel::Kernel>) -> Result<(), String> {
    ManagedAgentService::<crate::kernel::kernel::Kernel>::install(kernel)
}
...
impl ManagedAgentService<crate::kernel::kernel::Kernel> {
    ...
    pub(crate) fn install(kernel: &Arc<crate::kernel::kernel::Kernel>) -> Result<(), String> {
    ...
    pub(crate) fn install_returning(
        kernel: &Arc<crate::kernel::kernel::Kernel>,
        spawn_provider: Option<Arc<dyn SpawnTask<crate::kernel::kernel::Kernel>>>,
...
mod tests {
    ...
    mod procfs {
        use super::*;
        use crate::kernel::core::agents::registry::AgentSignal;
        use crate::kernel::kernel::Kernel;
